        ...
        <el-row :gutter="10">
          <el-col :span="5">
            <el-form-item label="用户昵称">
              <el-input clearable placeholder="输入用户昵称" v-model="searchForm.nickNameFuzzy" />
            </el-form-item>
          </el-col>
          <el-col :span="5">
...
const SEX_MAP: Record<number, string> = { 0: '未知', 1: '女', 2: '男' }

const columns = [
  { label: '头像', prop: 'avatar', width: 100, scopedSlots: 'slotAvatar' },
  { label: '昵称', prop: 'nickName', width: 150, scopedSlots: 'slotNickName' },
  { label: '邮箱', prop: 'email', width: 150 },
  { label: '出生日期', prop: 'birthday', width: 150 },
  { label: '加入时间', prop: 'joinTime', scopedSlots: 'slotJoinTime', width: 300 },
  { label: '最后登录IP', prop: 'lastLoginIp', width: 150 },
  { label: '简介', prop: 'personIntroduction' },
  { label: '硬币数量', prop: 'coin', scopedSlots: 'slotCoin' },
  { label: '状态', prop: 'status', scopedSlots: 'slotStatus' },
  { label: '操作', prop: 'operation', width: 80, scopedSlots: 'slotOperation' },
]
