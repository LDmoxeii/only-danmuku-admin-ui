...
const columns = [
  { label: '发送者', prop: 'nickName', width: 150, scopedSlots: 'slotNickName' },
  { label: '播放时间', prop: 'time', scopedSlots: 'time', width: 100 },
  { label: '弹幕内容', prop: 'text', scopedSlots: 'slotText' },
  { label: '发送时间', prop: 'postTime', width: 180 },
